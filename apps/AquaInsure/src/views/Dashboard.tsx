...
const Dashboard = () => {
  ...
  return (
    <>
      ...
      <div
        className="h-full min-h-[100dvh] bg-stone-50 dark:bg-stone-950 flex flex-col relative overflow-hidden"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col">
          {/* HEADER */}
          <div
            className="header-clip relative overflow-hidden z-10 px-5 sm:px-6 pt-7 sm:pt-8 pb-7 sm:pb-8 shrink-0"
            style={{
          ...
          <motion.p
            ...
            className="relative z-10 text-center text-[9px] font-medium py-3 pb-6 tracking-wide text-stone-400 dark:text-stone-600 shrink-0"
          >
            {t("auth.copyright")}
          </motion.p>
        </div>
